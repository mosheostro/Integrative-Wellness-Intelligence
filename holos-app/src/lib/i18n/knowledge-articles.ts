...
const listingDE: ListingArticles = {
  ...
  articles: [
    ...
    { id: 'swarga-tradition',     category: 'Traditionen',       title: 'Das Svarga-Prinzip: Synthese als höchste Weisheitstradition',                         excerpt: 'Acht Traditionen. Eine Intelligenz. Wie HOLOS fünf Jahrtausende Wellness-Weisheit in ein personalisiertes Framework synthetisiert, das keine einzelne Tradition alleine hätte schaffen können.', intro: 'Acht Traditionen. Eine Intelligenz. Wie HOLOS fünf Jahrtausende Wellness-Weisheit in ein personalisiertes Framework synthetisiert, das keine einzelne Tradition alleine hätte schaffen können.', date: 'Januar 2025', readTime: '6 Min.' },
  ],
}
