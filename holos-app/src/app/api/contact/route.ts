          ...
          html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr><td style="padding: 8px 0; color: #666; width: 120px; font-size: 0.85rem;">Name</td><td style="padding: 8px 0; font-weight: 600;">${name}</td></tr>
                <tr><td style="padding: 8px 0; color: #666; font-size: 0.85rem;">Email</td><td style="padding: 8px 0;"><a href="mailto:${email}">${email}</a></td></tr>
                ${phone ? `<tr><td style="padding: 8px 0; color: #666; font-size: 0.85rem;">Phone</td><td style="padding: 8px 0;">${phone}</td></tr>` : ''}
                <tr><td style="padding: 8px 0; color: #666; font-size: 0.85rem;">Subject</td><td style="padding: 8px 0;">${subject || '—'}</td></tr>
              </table>
              <div style="margin: 24px 0; padding: 20px; background: #FAF7F2; border-radius: 8px; border-left: 3px solid #7A9E8E;">
                ...
                <div style="line-height: 1.65; white-space: pre-wrap;">${message}</div>
              </div>
